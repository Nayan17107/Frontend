...
export default function AddProductForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!product.name || !product.brand || !product.gender || !product.price ||
            !product.mrp || !product.color || !product.quantity || !product.subcategory ||
            product.sizes.length === 0 || product.images.length === 0) {
        ...
        try {
            ...
            const addedProduct = await dispatch(addProductAsync(productToSubmit));
                        ...
                        <Form onSubmit={handleSubmit}>
                                            ...
                                            <div className="gender-selector">
                                                {["men", "women", "kids"].map((cat) => (
                                                    <div
                                                        ...
                                                        onClick={() => setProduct({ ...product, gender: cat, subcategory: "" })}
                                                    >
                            ...
                            <div className="form-section">
                                ...
                                <Form.Group className="mb-4">
                                    ...
                                    {product.sizes.length === 0 && (
                                        <div className="text-danger small mt-1">Please select at least one size</div>
                                    )}
                                </Form.Group>
                            </div>
                            ...
                            <div className="form-section">
                                ...
                                <Form.Group className="mb-4">
                                    ...
                                    {product.images.length === 0 && (
                                        <div className="text-danger small mt-1">Please add at least one image</div>
                                    )}
                                </Form.Group>
                            </div>
