...
//         if (product.gender) navigate(`/${product.gender}`);
//     };

//     return (
//         <>
//             <Header />
//             <Form className="add-product-form p-4 rounded-4 shadow mx-auto" onSubmit={handleSubmit}>
//                 <h3 className="mb-4 text-center form-title">Add Product</h3>
...
//                             <Form.Control type="number" value={product.discount} disabled className="form-input" />
//                         </Form.Group>
//                     </Col>
//                 </Row>
...
//                             <Form.Select name="color" value={product.color} onChange={handleChange} className="form-input">
...
//                             className="form-input"
//                         />
//                         <Button variant="warning" onClick={addImage} className="btn-hover">
//                             Add
//                         </Button>
//                     </div>
...
//                             <div key={i} className="position-relative image-preview">
//                                 <img src={img} alt="" />
//                                 <Button size="sm" variant="danger" className="position-absolute top-0 end-0 btn-hover" onClick={() => removeImage(i)}>
//                                     ×
//                                 </Button>
//                             </div>
//                         ))}
...
//                 <Button type="submit" variant="success" className="w-100 fw-bold btn-hover">
//                     ✅ Add Product
//                 </Button>
//             </Form>
//             <Footer />
