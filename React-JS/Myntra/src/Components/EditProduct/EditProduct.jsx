...
import { getProductAsync, updateProductAsync } from "../../Services/Actions/ProductActions";
...
export default function EditProductForm() {
    ...
    const { product: currentProduct, isLoading } = useSelector(state => state.products);
            ...
            <div className="edit-product-container">
                ...
                <Card className="edit-product-card">
                    <Card.Header className="card-header">
                        ...
                        <p className="form-subtitle">Update the product details below</p>
                    </Card.Header>
